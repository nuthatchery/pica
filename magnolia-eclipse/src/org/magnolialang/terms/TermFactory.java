...
public class TermFactory {
		...
		public static final Type Cons_Token = tf.constructor(ts, Type_XaToken, "token", 
				tf.stringType(), "chars");
		public static final Type Cons_Space = tf.constructor(ts, Type_XaToken, "space", 
				tf.stringType(), "chars");
		public static final Type Cons_Comment = tf.constructor(ts, Type_XaToken, "comment", 
				tf.stringType(), "chars");
		public static final Type Cons_Child = tf.constructor(ts, Type_XaToken, "child", 
				tf.integerType(), "index");
		public static final Type Cons_CtxChild = tf.constructor(ts, Type_XaToken, "ctxchild", 
				tf.integerType(), "index", tf.valueType(), "context");
		public static final Type Cons_Sep = tf.constructor(ts, Type_XaToken, "sep", 
				Type_XaToken, "tok", tf.stringType(), "chars");
		
		public static IConstructor cons(String name, String sort, IValue... args) {
			...
			IConstructor cons =  vf.constructor(consType, args);
			return cons;
		}
		
		public static IConstructor leaf(String strVal, String sort) {
			return vf.constructor(Cons_Leaf, vf.string(strVal));
		}
		
		public static IConstructor seq(String sort, IList args) {
			return vf.constructor(Cons_Seq, args);
		}
		
		public static IConstructor seq(String sort, IValue...args) {
		...
		public static IConstructor token(String chars) {
			return vf.constructor(Cons_Token, vf.string(chars));
		}

		public static IConstructor space(String chars) {
			return vf.constructor(Cons_Space, vf.string(chars));
		}

		public static IConstructor comment(String chars) {
			return vf.constructor(Cons_Comment, vf.string(chars));
		}

		public static IConstructor child(int index) {
			return vf.constructor(Cons_Child, vf.integer(index));
		}

		public static IConstructor child(int index, IValue context) {
			return vf.constructor(Cons_CtxChild, vf.integer(index), context);
		}

		public static IConstructor sep(IConstructor tok, String chars) {
