...
class MagnoliaSkinTable {
	public static Map<String,IList> getMap() {
		...
		tbl.put("Morphisms/1:Morphism", vf.list(token("["), space(" "), sep(child(0),","), space(" "), token("]")));
		tbl.put("PredClause/2:PredClause", vf.list(token("predicate"), space(" "), child(0), space(" "), child(1)));
		tbl.put("Partition/2:Decl", vf.list(token("partition"), space(" "), child(0), space(" "), token("by"), space(" "), sep(child(1),","), space(" "), token(";")));
		tbl.put("Oct/1:Literal", vf.list(child(0)));
		tbl.put("Free/2:Decl", vf.list(token("free"), space(" "), child(0), space(" "), token("by"), space(" "), sep(child(1),","), space(" "), token(";")));
		...
		tbl.put("Generate/2:Decl", vf.list(token("generate"), space(" "), child(0), space(" "), token("by"), space(" "), sep(child(1),","), space(" "), token(";")));
		...
		tbl.put("Morphism/2:MorphClause", vf.list(child(0), space(" "), token("="), space(" "), child(1)));
		...
		tbl.put("At/2:ConceptExpr", vf.list(child(0), space(" "), token("@"), space(" "), child(1)));
