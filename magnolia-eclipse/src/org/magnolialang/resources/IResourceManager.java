...
public interface IResourceManager {
	public static final Type Type_ModuleResource = tf.abstractDataType(ts,
			"ModuleResource");
	public static final Type Cons_ModuleResource = tf.constructor(ts,
			Type_ModuleResource, "ModuleResource", tf.stringType(), "val");
	public static final Type Type_FileResource = tf.abstractDataType(ts,
			"FileResource");
	public static final Type Cons_FileResource = tf.constructor(ts,
			Type_ModuleResource, "FileResource", tf.stringType(), "val");
	 ...
	 * 
	 * May return null if the path does not exist in the file system.
	 * 
	 * @param path
